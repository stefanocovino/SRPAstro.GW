...
if !(-e $rt:r_8.tab) then
    set cmd = "SRPGWAdaptSelect -v -i $rt:r_7.tab -o $rt:r_8.tab -M -m $magthreshold -C -S -s $scothreshold -n 500 -X -x $varindexthreshold"
    echo $cmd
    eval $cmd
endif
#
...
#
echo "./03.CIMP.Selezione.csh $rt:r_7.tab $rt:r_14.tab"
